...
\hline
\textbf{Dataset} & \textbf{Description} & \textbf{Platform} & \textbf{Link} \\
\hline
Multi-branch Model & The multi-branch ensemble model. & Hugging Face & \href{https://huggingface.co/datasets/placeholder}{View Dataset} \\
\hline
    LSST Photometry / HST SFR & LSST FITS-based dataset. This dataset is covered in detail in \href{https://example.com}{this} paper. & Kaggle & \href{https://kaggle.com/datasets/placeholder}{View Dataset} \\
\hline
\end{longtable}
