...
\hline
    LSST Photometry / HST SFR & LSST FITS-based dataset. This dataset is covered in detail \href{https://github.com/dsergio-thesis/.github/wiki/Datasets}{here}. & Kaggle & \href{https://www.kaggle.com/datasets/dsergio/lsst-images-photometry-hst-sfr-labels-1118-samples}{Example LSST/HST Labeled Dataset} \\
\hline
\end{longtable}
