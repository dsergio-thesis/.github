...
\begin{longtable}{|p{5cm}|p{3cm}|p{1cm}|p{4cm}|}
    ...
    Classification of Extended Extragalactic Objects in LSST Survey Data using Supervised Machine Learning & Eastern Washington University & 2026 & \href{https://example.com}{Placeholder} \\
    \hline
...
\hline
Multi-branch Model & The multi-branch ensemble model. & Hugging Face & \href{https://huggingface.co/datasets/placeholder}{Placeholder} \\
\hline
    LSST Photometry / HST SFR & LSST FITS-based dataset. This dataset is covered in detail in \href{https://example.com}{this} paper. & Kaggle & \href{https://kaggle.com/datasets/placeholder}{Placeholder} \\
\hline
\end{longtable}
