...
\hline
A literature review of supervised and unsupervised machine learning approaches for classification of extended extragalactic objects in astronomical survey data & Eastern Washington University Research Methods & 2025 & \url{https://github.com/dsergio-thesis/.github/blob/main/papers/Literature_Review.pdf}  \\
\hline
    Identifying galaxies, quasars, and stars with machine learning: A new catalogue of classifications for 111 million SDSS sources without spectra& Journal Astronomy and Astrophysics & 2020 & \url{https://github.com/dsergio-thesis/.github/blob/main/presentations/Presentation_Clarke2020.pdf} \\
\hline
\end{longtable}
